...
const services = [
  {
    number: "01", title: "Инъектирование",
  ...
  {
    number: "02", title: "Усиление конструкций",
  ...
  {
    number: "03", title: "Обследование зданий",
  ...
  {
    number: "04", title: "Проектирование",
  ...
  {
    number: "05", title: "Торкретирование",
  ...
  {
    number: "06", title: "Поставка материалов",
...
const projects = [
  {
    title: "Москва-Сити", type: "Инъекционная гидроизоляция",
...
const officePhotos = [
  { src: "https://sdt.swipa.ru/assets/company/office-open-space.jpg", alt: "Открытый офис СДТ", label: "Открытое рабочее пространство" },
  { src: "https://sdt.swipa.ru/assets/company/office-workspace-wide.jpg", alt: "Рабочие места сотрудников СДТ", label: "Рабочие места инженеров" },
  { src: "https://sdt.swipa.ru/assets/company/office-workroom.jpg", alt: "Рабочая комната офиса СДТ", label: "Проектная комната" },
  { src: "https://sdt.swipa.ru/assets/company/office-project-room.jpg", alt: "Сотрудники СДТ работают с документацией", label: "Работа с документацией" },
  { src: "https://sdt.swipa.ru/assets/company/office-meeting-room.jpg", alt: "Переговорная комната СДТ", label: "Переговорная" },
];

const eventPhotos = [
  { src: "https://sdt.swipa.ru/assets/company/event-team-gathering.jpg", title: "Общая встреча команды", tag: "Фотоархив СДТ" },
  { src: "https://sdt.swipa.ru/assets/company/event-engineering-meeting.jpg", title: "Рабочее совещание", tag: "Обмен опытом" },
  { src: "https://sdt.swipa.ru/assets/company/event-site-team.jpg", title: "Команда на объекте", tag: "Строительная площадка" },
];

const teamCards = [
  { src: "https://sdt.swipa.ru/assets/company/team-company.jpg", title: "Единая команда", copy: "Инженеры, проектировщики и специалисты производства объединяют опыт на каждом этапе проекта." },
  { src: "https://sdt.swipa.ru/assets/company/team-object-engineers.jpg", title: "Инженеры на объектах", copy: "Обследуют конструкции, подбирают технологии и сопровождают выполнение работ." },
  { src: "https://sdt.swipa.ru/assets/company/team-field-training.jpg", title: "Профессиональное развитие", copy: "Командные выезды помогают обмениваться практическим опытом и работать согласованно." },
  { src: "https://sdt.swipa.ru/assets/company/team-production.jpg", title: "Производственная команда", copy: "Выполняет работы на действующих площадках с контролем технологии и качества." },
];
